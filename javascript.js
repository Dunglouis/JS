...
var list = document.getElementById("list-infor-id")  // lí do ko dùng const ??
...
function onClickadditem(){
    ...
    computeListHtml()
    input.value = "" // xoa noi dung da nhap sau khi bam button add
}

function onClickremoveitem(i){ // tai sao chuyen remove vao div lai ko ddc
    todo.splice(i, 1)
    computeListHtml()
}
